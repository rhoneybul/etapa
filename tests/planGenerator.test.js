 ...
 *   node --import ./tests/loader.mjs tests/planGenerator.test.js --api https://etapa.up.railway.app --key YOUR_TEST_API_KEY
 */
...
const SCENARIOS = [
  ...
  // ─── 31–34. REGRESSION tests ───────────────────────────────────────────────
  // Each one locks down a specific bug reported in April 2026. If any of these
  // starts failing, the bug has returned.

  // Bug: user selected 3 rides per week, got 1 ride + 1 strength session. Root
  // cause: ambiguous session-count prompt + uninvited strength from beginner
  // block + strength example present even when not requested.
  {
    name: 'REGRESSION: 3 rides/week outdoor only, NO strength',
    goal: { id: 'reg1', goalType: 'improve', cyclingType: 'road', planName: 'Reg #1' },
    config: {
      id: 'creg1', daysPerWeek: 3, weeks: 6, trainingTypes: ['outdoor'],
      sessionCounts: { outdoor: 3 },
      availableDays: ['monday', 'wednesday', 'saturday'],
      fitnessLevel: 'intermediate', startDate: '2026-04-06',
    },
  },

  // Bug: beginner flow unconditionally added strength from week 3.
  {
    name: 'REGRESSION: beginner flow, outdoor only, NO strength',
    goal: { id: 'reg2', goalType: 'beginner', cyclingType: 'road', planName: 'Reg #2' },
    config: {
      id: 'creg2', daysPerWeek: 3, weeks: 12, trainingTypes: ['outdoor'],
      sessionCounts: { outdoor: 3 },
      availableDays: ['tuesday', 'thursday', 'saturday'],
      fitnessLevel: 'beginner', startDate: '2026-04-06',
    },
  },

  // Positive test: strength IS requested — must include the correct count.
  {
    name: 'REGRESSION: 3 rides + 1 strength explicitly requested',
    goal: { id: 'reg3', goalType: 'improve', cyclingType: 'road', planName: 'Reg #3' },
    config: {
      id: 'creg3', daysPerWeek: 4, weeks: 6, trainingTypes: ['outdoor', 'strength'],
      sessionCounts: { outdoor: 3, strength: 1 },
  ...
  {
    name: 'REGRESSION: 5 rides/week honoured in build phase',
    goal: { id: 'reg4', goalType: 'distance', cyclingType: 'road', targetDistance: 120, planName: 'Reg #4' },
    config: {
      id: 'creg4', daysPerWeek: 5, weeks: 8, trainingTypes: ['outdoor'],
      sessionCounts: { outdoor: 5 },
      availableDays: ['monday', 'tuesday', 'thursday', 'saturday', 'sunday'],
      fitnessLevel: 'advanced', startDate: '2026-04-06',
    },
  },

  // ─── "Just get better" flow (goalType: 'improve') coverage ───────────────
  { name: 'JUST GET BETTER: beginner 2 days/week 4 weeks',
    goal: { id: 'jgb1', goalType: 'improve', cyclingType: 'mixed', planName: 'Keep improving' },
    config: { id: 'cjgb1', daysPerWeek: 2, weeks: 4, trainingTypes: ['outdoor'], availableDays: ['wednesday', 'saturday'], fitnessLevel: 'beginner', startDate: '2026-04-06' } },
  { name: 'JUST GET BETTER: intermediate 3 days/week 8 weeks',
    goal: { id: 'jgb2', goalType: 'improve', cyclingType: 'mixed', planName: 'Keep improving' },
    config: { id: 'cjgb2', daysPerWeek: 3, weeks: 8, trainingTypes: ['outdoor'], availableDays: ['tuesday', 'thursday', 'saturday'], fitnessLevel: 'intermediate', startDate: '2026-04-06' } },
  { name: 'JUST GET BETTER: intermediate 4 days + strength 12 weeks',
    goal: { id: 'jgb3', goalType: 'improve', cyclingType: 'mixed', planName: 'Keep improving' },
    config: { id: 'cjgb3', daysPerWeek: 4, weeks: 12, trainingTypes: ['outdoor', 'strength'], availableDays: ['monday', 'wednesday', 'friday', 'saturday'], fitnessLevel: 'intermediate', startDate: '2026-04-06' } },
  { name: 'JUST GET BETTER: advanced 5 days outdoor+indoor 10 weeks',
    goal: { id: 'jgb4', goalType: 'improve', cyclingType: 'road', planName: 'Keep improving' },
    config: { id: 'cjgb4', daysPerWeek: 5, weeks: 10, trainingTypes: ['outdoor', 'indoor'], availableDays: ['monday', 'tuesday', 'thursday', 'saturday', 'sunday'], fitnessLevel: 'advanced', startDate: '2026-04-06' } },
  { name: 'JUST GET BETTER: e-bike intermediate 3 days 6 weeks',
    goal: { id: 'jgb5', goalType: 'improve', cyclingType: 'ebike', planName: 'Keep improving' },
    config: { id: 'cjgb5', daysPerWeek: 3, weeks: 6, trainingTypes: ['outdoor'], availableDays: ['tuesday', 'thursday', 'sunday'], fitnessLevel: 'intermediate', startDate: '2026-04-06' } },
  { name: 'JUST GET BETTER: long ride on Sunday picked explicitly',
    goal: { id: 'jgb6', goalType: 'improve', cyclingType: 'road', planName: 'Keep improving' },
    config: { id: 'cjgb6', daysPerWeek: 4, weeks: 8, trainingTypes: ['outdoor'], availableDays: ['tuesday', 'thursday', 'saturday', 'sunday'], fitnessLevel: 'intermediate', startDate: '2026-04-06', longRideDay: 'sunday' } },

  // ─── "Getting started" flow (goalType: 'beginner') coverage ──────────────
  { name: 'GETTING STARTED: 2 days/week 6 weeks, pure outdoor',
    goal: { id: 'gs1', goalType: 'beginner', cyclingType: 'road', planName: 'Get Into Cycling' },
    config: { id: 'cgs1', daysPerWeek: 2, weeks: 6, trainingTypes: ['outdoor'], availableDays: ['wednesday', 'saturday'], fitnessLevel: 'beginner', startDate: '2026-04-06' } },
  { name: 'GETTING STARTED: 3 days/week 8 weeks, pure outdoor',
    goal: { id: 'gs2', goalType: 'beginner', cyclingType: 'road', planName: 'Get Into Cycling' },
    config: { id: 'cgs2', daysPerWeek: 3, weeks: 8, trainingTypes: ['outdoor'], availableDays: ['tuesday', 'thursday', 'saturday'], fitnessLevel: 'beginner', startDate: '2026-04-06' } },
  { name: 'GETTING STARTED: 3 days/week 12 weeks, full couch-to-25km',
    goal: { id: 'gs3', goalType: 'beginner', cyclingType: 'road', planName: 'Get Into Cycling' },
    config: { id: 'cgs3', daysPerWeek: 3, weeks: 12, trainingTypes: ['outdoor'], availableDays: ['monday', 'wednesday', 'saturday'], fitnessLevel: 'beginner', startDate: '2026-04-06' } },
  { name: 'GETTING STARTED: 2 days/week 12 weeks, slow build',
    goal: { id: 'gs4', goalType: 'beginner', cyclingType: 'road', planName: 'Get Into Cycling' },
    config: { id: 'cgs4', daysPerWeek: 2, weeks: 12, trainingTypes: ['outdoor'], availableDays: ['wednesday', 'sunday'], fitnessLevel: 'beginner', startDate: '2026-04-06' } },
  { name: 'GETTING STARTED: 3 rides + 1 strength, 10 weeks',
    goal: { id: 'gs5', goalType: 'beginner', cyclingType: 'road', planName: 'Get Into Cycling' },
    config: { id: 'cgs5', daysPerWeek: 4, weeks: 10, trainingTypes: ['outdoor', 'strength'], sessionCounts: { outdoor: 3, strength: 1 }, availableDays: ['tuesday', 'wednesday', 'thursday', 'saturday'], fitnessLevel: 'beginner', startDate: '2026-04-06' } },
  { name: 'GETTING STARTED: e-bike 2 days/week 8 weeks',
    goal: { id: 'gs6', goalType: 'beginner', cyclingType: 'ebike', planName: 'Get Into Cycling' },
    config: { id: 'cgs6', daysPerWeek: 2, weeks: 8, trainingTypes: ['outdoor'], availableDays: ['wednesday', 'saturday'], fitnessLevel: 'beginner', startDate: '2026-04-06' } },
  { name: 'GETTING STARTED: long ride pre-set to Sunday',
    goal: { id: 'gs7', goalType: 'beginner', cyclingType: 'road', planName: 'Get Into Cycling' },
    config: { id: 'cgs7', daysPerWeek: 3, weeks: 8, trainingTypes: ['outdoor'], availableDays: ['tuesday', 'thursday', 'sunday'], fitnessLevel: 'beginner', startDate: '2026-04-06', longRideDay: 'sunday' } },

  // ─── "Just get better" edge cases — deliberately awkward/unusual setups ──
  { name: 'EDGE (just-better): weekday warrior M/W/F only',
    goal: { id: 'eb1', goalType: 'improve', cyclingType: 'road', planName: 'Keep improving' },
    config: { id: 'ceb1', daysPerWeek: 3, weeks: 8, trainingTypes: ['outdoor'], availableDays: ['monday', 'wednesday', 'friday'], fitnessLevel: 'beginner', startDate: '2026-04-06' } },
  { name: 'EDGE (just-better): weekends-only 2-day intermediate',
    goal: { id: 'eb2', goalType: 'improve', cyclingType: 'road', planName: 'Keep improving' },
    config: { id: 'ceb2', daysPerWeek: 2, weeks: 8, trainingTypes: ['outdoor'], availableDays: ['saturday', 'sunday'], fitnessLevel: 'intermediate', startDate: '2026-04-06', longRideDay: 'saturday' } },
  { name: 'EDGE (just-better): 1 day/week commuter absolute minimum',
    goal: { id: 'eb3', goalType: 'improve', cyclingType: 'road', planName: 'Keep improving' },
    config: { id: 'ceb3', daysPerWeek: 1, weeks: 6, trainingTypes: ['outdoor'], availableDays: ['saturday'], fitnessLevel: 'beginner', startDate: '2026-04-06' } },
  { name: 'EDGE (just-better): every day available 5 sessions incl. strength',
    goal: { id: 'eb4', goalType: 'improve', cyclingType: 'road', planName: 'Keep improving' },
    config: { id: 'ceb4', daysPerWeek: 5, weeks: 8, trainingTypes: ['outdoor', 'indoor', 'strength'], sessionCounts: { outdoor: 3, indoor: 1, strength: 1 }, availableDays: ['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'], fitnessLevel: 'intermediate', startDate: '2026-04-06', longRideDay: 'saturday' } },
  { name: 'EDGE (just-better): mid-week long ride on Wednesday',
    goal: { id: 'eb5', goalType: 'improve', cyclingType: 'road', planName: 'Keep improving' },
    config: { id: 'ceb5', daysPerWeek: 3, weeks: 8, trainingTypes: ['outdoor'], availableDays: ['monday', 'wednesday', 'friday'], fitnessLevel: 'intermediate', startDate: '2026-04-06', longRideDay: 'wednesday' } },
  { name: 'EDGE (just-better): very short 2-week reset plan',
    goal: { id: 'eb6', goalType: 'improve', cyclingType: 'road', planName: 'Keep improving' },
    config: { id: 'ceb6', daysPerWeek: 3, weeks: 2, trainingTypes: ['outdoor'], availableDays: ['tuesday', 'thursday', 'saturday'], fitnessLevel: 'beginner', startDate: '2026-04-06' } },
  { name: 'EDGE (just-better): 16-week beginner improvement arc',
    goal: { id: 'eb7', goalType: 'improve', cyclingType: 'road', planName: 'Keep improving' },
    config: { id: 'ceb7', daysPerWeek: 3, weeks: 16, trainingTypes: ['outdoor'], availableDays: ['tuesday', 'thursday', 'sunday'], fitnessLevel: 'beginner', startDate: '2026-04-06' } },
  { name: 'EDGE (just-better): 3 rides + 2 strength atypical split',
    goal: { id: 'eb8', goalType: 'improve', cyclingType: 'road', planName: 'Keep improving' },
    config: { id: 'ceb8', daysPerWeek: 5, weeks: 8, trainingTypes: ['outdoor', 'strength'], sessionCounts: { outdoor: 3, strength: 2 }, availableDays: ['monday', 'tuesday', 'wednesday', 'friday', 'saturday'], fitnessLevel: 'intermediate', startDate: '2026-04-06' } },
  { name: 'EDGE (just-better): indoor-only trainer 3 days',
    goal: { id: 'eb9', goalType: 'improve', cyclingType: 'road', planName: 'Keep improving' },
    config: { id: 'ceb9', daysPerWeek: 3, weeks: 6, trainingTypes: ['indoor'], sessionCounts: { indoor: 3 }, availableDays: ['monday', 'wednesday', 'friday'], fitnessLevel: 'intermediate', startDate: '2026-04-06' } },
  { name: 'EDGE (just-better): gravel 4 days 10 weeks',
    goal: { id: 'eb10', goalType: 'improve', cyclingType: 'gravel', planName: 'Keep improving' },
    config: { id: 'ceb10', daysPerWeek: 4, weeks: 10, trainingTypes: ['outdoor'], availableDays: ['monday', 'wednesday', 'friday', 'saturday'], fitnessLevel: 'intermediate', startDate: '2026-04-06' } },
  { name: 'EDGE (just-better): MTB beginner 3 days',
    goal: { id: 'eb11', goalType: 'improve', cyclingType: 'mtb', planName: 'Keep improving' },
    config: { id: 'ceb11', daysPerWeek: 3, weeks: 8, trainingTypes: ['outdoor'], availableDays: ['tuesday', 'thursday', 'saturday'], fitnessLevel: 'beginner', startDate: '2026-04-06' } },
  { name: 'EDGE (just-better): advanced on 2 days/week minimal time',
    goal: { id: 'eb12', goalType: 'improve', cyclingType: 'road', planName: 'Keep improving' },
    config: { id: 'ceb12', daysPerWeek: 2, weeks: 6, trainingTypes: ['outdoor'], availableDays: ['wednesday', 'saturday'], fitnessLevel: 'advanced', startDate: '2026-04-06' } },
  { name: 'EDGE (just-better): 3-day plan starting mid-week Wed',
    goal: { id: 'eb13', goalType: 'improve', cyclingType: 'road', planName: 'Keep improving' },
    config: { id: 'ceb13', daysPerWeek: 3, weeks: 6, trainingTypes: ['outdoor'], availableDays: ['monday', 'wednesday', 'saturday'], fitnessLevel: 'intermediate', startDate: '2026-04-08' } },

  // ─── "Getting Started" edge cases ────────────────────────────────────────
  { name: 'EDGE (getting-started): 1 day/week couch-to-saddle',
    goal: { id: 'ebg1', goalType: 'beginner', cyclingType: 'road', planName: 'Get Into Cycling' },
    config: { id: 'cebg1', daysPerWeek: 1, weeks: 6, trainingTypes: ['outdoor'], availableDays: ['saturday'], fitnessLevel: 'beginner', startDate: '2026-04-06' } },
  { name: 'EDGE (getting-started): shift worker Tue/Wed/Thu only',
    goal: { id: 'ebg2', goalType: 'beginner', cyclingType: 'road', planName: 'Get Into Cycling' },
    config: { id: 'cebg2', daysPerWeek: 3, weeks: 8, trainingTypes: ['outdoor'], availableDays: ['tuesday', 'wednesday', 'thursday'], fitnessLevel: 'beginner', startDate: '2026-04-06' } },
  { name: 'EDGE (getting-started): weekends-only 2 days 10 weeks',
    goal: { id: 'ebg3', goalType: 'beginner', cyclingType: 'road', planName: 'Get Into Cycling' },
    config: { id: 'cebg3', daysPerWeek: 2, weeks: 10, trainingTypes: ['outdoor'], availableDays: ['saturday', 'sunday'], fitnessLevel: 'beginner', startDate: '2026-04-06', longRideDay: 'sunday' } },
  { name: 'EDGE (getting-started): 16-week slow-burn commitment',
    goal: { id: 'ebg4', goalType: 'beginner', cyclingType: 'road', planName: 'Get Into Cycling' },
    config: { id: 'cebg4', daysPerWeek: 3, weeks: 16, trainingTypes: ['outdoor'], availableDays: ['tuesday', 'thursday', 'saturday'], fitnessLevel: 'beginner', startDate: '2026-04-06' } },
  { name: 'EDGE (getting-started): 4-day morning commuter on e-bike',
    goal: { id: 'ebg5', goalType: 'beginner', cyclingType: 'ebike', planName: 'Get Into Cycling' },
    config: { id: 'cebg5', daysPerWeek: 4, weeks: 8, trainingTypes: ['outdoor'], availableDays: ['monday', 'tuesday', 'wednesday', 'thursday'], fitnessLevel: 'beginner', startDate: '2026-04-06' } },
  { name: 'EDGE (getting-started): full programme outdoor+indoor+strength',
    goal: { id: 'ebg6', goalType: 'beginner', cyclingType: 'road', planName: 'Get Into Cycling' },
    config: { id: 'cebg6', daysPerWeek: 5, weeks: 12, trainingTypes: ['outdoor', 'indoor', 'strength'], sessionCounts: { outdoor: 2, indoor: 2, strength: 1 }, availableDays: ['monday', 'tuesday', 'wednesday', 'friday', 'saturday'], fitnessLevel: 'beginner', startDate: '2026-04-06', longRideDay: 'saturday' } },
  { name: 'EDGE (getting-started): MTB absolute-beginner 3 days',
    goal: { id: 'ebg7', goalType: 'beginner', cyclingType: 'mtb', planName: 'Get Into Cycling' },
    config: { id: 'cebg7', daysPerWeek: 3, weeks: 8, trainingTypes: ['outdoor'], availableDays: ['tuesday', 'thursday', 'sunday'], fitnessLevel: 'beginner', startDate: '2026-04-06' } },
  { name: 'EDGE (getting-started): long ride on Friday (unusual)',
    goal: { id: 'ebg8', goalType: 'beginner', cyclingType: 'road', planName: 'Get Into Cycling' },
    config: { id: 'cebg8', daysPerWeek: 3, weeks: 8, trainingTypes: ['outdoor'], availableDays: ['monday', 'wednesday', 'friday'], fitnessLevel: 'beginner', startDate: '2026-04-06', longRideDay: 'friday' } },
  { name: 'EDGE (getting-started): 3-week short trial plan',
    goal: { id: 'ebg9', goalType: 'beginner', cyclingType: 'road', planName: 'Get Into Cycling' },
    config: { id: 'cebg9', daysPerWeek: 2, weeks: 3, trainingTypes: ['outdoor'], availableDays: ['wednesday', 'saturday'], fitnessLevel: 'beginner', startDate: '2026-04-06' } },
  { name: 'EDGE (getting-started): 2 days 4 weeks e-bike returner',
    goal: { id: 'ebg10', goalType: 'beginner', cyclingType: 'ebike', planName: 'Get Into Cycling' },
    config: { id: 'cebg10', daysPerWeek: 2, weeks: 4, trainingTypes: ['outdoor'], availableDays: ['wednesday', 'saturday'], fitnessLevel: 'beginner', startDate: '2026-04-06' } },
  { name: 'EDGE (getting-started): gravel 3 days 10 weeks',
    goal: { id: 'ebg11', goalType: 'beginner', cyclingType: 'gravel', planName: 'Get Into Cycling' },
    config: { id: 'cebg11', daysPerWeek: 3, weeks: 10, trainingTypes: ['outdoor'], availableDays: ['tuesday', 'thursday', 'sunday'], fitnessLevel: 'beginner', startDate: '2026-04-06' } },
  { name: 'EDGE (getting-started): 14-week standard couch-to-ride',
    goal: { id: 'ebg12', goalType: 'beginner', cyclingType: 'road', planName: 'Get Into Cycling' },
    config: { id: 'cebg12', daysPerWeek: 3, weeks: 14, trainingTypes: ['outdoor'], availableDays: ['tuesday', 'thursday', 'saturday'], fitnessLevel: 'beginner', startDate: '2026-04-06' } },
